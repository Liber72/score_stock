...
def run_all_groups_analysis():
    ...
    nhom_1_symbols = pd.read_csv('Group1.csv')['symbol'].tolist()
    nhom_2_symbols = pd.read_csv('Group2.csv')['symbol'].tolist()
    nhom_3_symbols = pd.read_csv('Group3.csv')['symbol'].tolist()
    nhom_4_symbols = pd.read_csv('Group4.csv')['symbol'].tolist()
    run_spread_analysis(
        symbols=nhom_4_symbols,
        group_label="Group4",
        days=15,
    )
    run_spread_analysis(
        symbols=nhom_1_symbols,
        group_label="Group1",
        days=15,
    )
    run_spread_analysis(
        symbols=nhom_2_symbols,
        group_label="Group2",
        days=15,
    )
    run_spread_analysis(
        symbols=nhom_3_symbols,
        group_label="Group3",
        days=15,
    )
